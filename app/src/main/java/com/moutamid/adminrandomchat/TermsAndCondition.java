...
import com.moutamid.adminrandomchat.databinding.ActivityTermsAndConditionBinding;
...
public class TermsAndCondition extends AppCompatActivity {
    ...
    private ActivityTermsAndConditionBinding b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b = ActivityTermsAndConditionBinding.inflate(getLayoutInflater());
    ...
    private void getTermsAndConditions() {
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.child("terms_condition_url").exists()){
                    url = snapshot.child("terms_condition_url").getValue().toString();
                    loadUrl(url);
                }
            }
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!link.isEmpty()){
                    ...
                    hashMap.put("terms_condition_url",link);
